...
function getBasePath() {
  ...
  if (isDevelopment) {
    return 'user-files';
  } else if (window.electronAPI.getExePath()) {
    return window.electronAPI.getExePath() + '/resources/user-files'; // Useful for portable mode
  } else {
    return window.electronAPI.getResourcePath() + '/user-files';
  }
}
